...
export default class DiveTeamMember{
    constructor(id_, id_palanquée_, temporary_diver_qualification_, current_diver_qualification_, diver_role_, current_instructor_qualification_, nox_percentage_, comment_, paid_amount_){
        this.id = id_;
        ...
        this.current_instructor_qualification = current_instructor_qualification_;
    ...
    get_current_instructor_qualification() {
        return this.current_instructor_qualification;
    }

    set_current_instructor_qualification(current_instructor_qualification_) {
        this.current_instructor_qualification = current_instructor_qualification_;
    }
